const initialCategories = [
  ...
  { name: 'Коммунальные услуги', icon_name: 'droplet', highlight_color: 'AQUA_BLUE' },
  ...
  // Entertainment
  { name: 'Кафе и рестораны', icon_name: 'coffee', highlight_color: 'SUNSET_ORANGE' },
  ...
  { name: 'Инвестиции', icon_name: 'trending-up', highlight_color: 'ELECTRIC_GREEN' },
  ...
  { name: 'Благотворительность', icon_name: 'hand-heart', highlight_color: 'RUBY_RED' },
  { name: 'Неожиданные расходы', icon_name: 'alert-circle', highlight_color: 'ASH_GRAY' }
];